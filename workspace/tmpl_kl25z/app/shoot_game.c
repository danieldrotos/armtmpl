...
struct bull_t bulls[bnr];
struct ship_t ships[snr];
struct row_t  rows[25];
int nuof_bulls, nuof_ships;
int shoot_run;
unsigned int last_down, next_down;
int game_over;
int bull_time= 100, down_min= 5000, down_max= 10000;
int shift_time= 2000;
